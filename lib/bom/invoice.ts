...
<body>
  ...
  <header>
    <div>
      <h1>TMRW FOUNDATION</h1>
      <div style="font-size:11px;color:#6b7282;line-height:1.5;">Branded boardroom &amp; office spaces<br/>Frankfurt am Main, Germany<br/>USt-IdNr DE000 000 000</div>
    </div>
    <div class="meta">
  ...
  <div class="grid">
    ...
    <div>
      ...
      <div>${Math.round(meta.areaM2)} m² room · reuse ${meta.reuse}%</div>
    </div>
  </div>
  ...
  <footer>
    Payment within 30 days. Quoted in EUR, exclusive of additional on-site labour above scheduled days. All modular partition and glazing components remain TMRW Foundation property and are charged on a reuse-discount model; consumables (vinyl, print) are non-returnable. Sustainability metrics computed against the 2026 TMRW Foundation baseline. — This invoice was generated by the TMRW Foundation Configurator (demo).
  </footer>
</body>
</html>`;
  w.document.open();
